...
CREATE INDEX "user_device_authorizations_user_idx" ON "user_device_authorizations" USING btree ("user_id" int4_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "users_username_idx" ON "users" USING btree ("username" text_ops);